...
describe 'Session 1', type: :feature do
  ...
  it 'answers question 9' do
    ...
    text = ['You feel that there is nobody in your life', 'Excellent!']
    text.each do |slide_text|
      answer_question
      click_on 'Continue'
  ...
  it 'answers question 10' do
    ...
    text = ['You feel that there is nobody in your life', 'Excellent!',
            "You've decided to do this quit attempt"]
    text.each do |slide_text|
      answer_question
      click_on 'Continue'
      expect(page).to have_content slide_text
  ...
  it 'answers question 14' do
    ...
    text = ['Difficult Times To Stay Smoke Free', 'Receiving Reminders To Stay on Track']
    text.each do |slide_text|
      answer_question
      click_on 'Continue'
      expect(page).to have_content slide_text
