...
module Sessions
  ...
  SESSION_1 = [
    { 'sessionDate' => DateTime.now.iso8601(3),
      ...
      'sessionType' => 'session_1',
      'type' => 'sessions',
      'isDirty' => true }
  ].to_json

  SESSION_2 = [
    { 'sessionDate' => (DateTime.now - 14).iso8601(3),
  ...
  SESSION_3 = [
    { 'sessionDate' => (DateTime.now - 14).iso8601(3),
      ...
      'type' => 'sessions',
      'isDirty' => true },
    { 'sessionDate' => (DateTime.now - 8).iso8601(3),
      'id' => '497995f7-baa3-4fe0-b42-19c424b87d1e',
      'sessionType' => 'session_2',
      'type' => 'sessions',
      'isDirty' => true },
    { 'sessionDate' => DateTime.now.iso8601(3),
      'id' => '95a64771-1797-4bad-a8a6-003ea4bfd8ca',
      'sessionType' => 'session_3',
      'type' => 'sessions',
      'isDirty' => true }
  ].to_json
end
